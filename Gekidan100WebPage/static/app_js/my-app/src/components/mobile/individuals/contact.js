...
import {ajax} from "../../actions/action";
            ...
            <React.Fragment>
                <div className="wrap-form">
                    ...
                    <div className="form-group" id="nameId">
                        <label>お名前</label>
                        <div>
                            <TextField label="性" variant="filled" onChange={secondName} InputProps={{'style': {background:'white'}}} />
                            <TextField label="名" variant="filled" onChange={firstName} InputProps={{'style': {background:'white'}}} />
                        </div>
                    </div>
                    <div className="form-group" id="furiganaId">
                        <label>フリガナ</label>
                        <div>
                            <TextField label="セイ" variant="filled" onChange={secondPhonetic} InputProps={{'style': {background:'white'}}} />
                            <TextField label="メイ" variant="filled" onChange={firstPhonetic} InputProps={{'style': {background:'white'}}} />
                        </div>
                    </div>
                    <div className="form-group" id="mailAddress">
                        <label>メールアドレス</label>
                        <TextField label="メールアドレス" variant="filled" onChange={mailAddress} InputProps={{'style': {background:'white'}, 'aria-describedby': 'emailHelp'}} style={{width: '100%'}} />
                    </div>
